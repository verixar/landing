          ...
          >
            ...
            <div className="space-y-6">
              <p className="text-white text-lg md:text-xl leading-relaxed font-light">
                ...
                instant, and reliable for everyone. At Verixar, we're building a
                smarter way to verify insurance status — one that removes
                uncertainty, reduces fraud, and helps people make confident
                decisions before they buy.
              </p>

              <p className="text-white text-lg md:text-xl leading-relaxed font-light">
                Learn more about our journey, the problem we're solving, and the
                passionate team working behind the scenes to make secure
