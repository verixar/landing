        ...
        <div className="flex flex-col lg:flex-row items-center justify-start gap-8 lg:gap-6">
          <div className="flex-1 flex flex-col justify-center space-y-6 md:space-y-8 text-center lg:text-left max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-6 pt-4">
              <button className="w-full sm:w-auto px-10 py-4 bg-white text-[#0056D6] rounded-sm font-regular text-lg hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                Join the Waitlist
              </button>

              <button className="w-full sm:w-auto flex items-center justify-center space-x-3 px-10 py-4 border-2 border-white/30 text-white rounded-sm font-regular text-lg hover:bg-white/10 transition-all">
